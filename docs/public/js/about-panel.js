...
(function() {
  ...
  const aboutPanelHTML = `
    <div id="about-panel-overlay" class="custom-alert-overlay" style="display: none;">
      <div id="about-panel" class="custom-alert" style="width: 320px; max-width: 90%;">
        <div class="custom-alert-title">关于作者</div>
        <div class="custom-alert-content" style="text-align: center;">
          <img src="/doc/author.gif" alt="作者头像" style="width: 100px; height: 100px; border-radius: 50%; margin-bottom: 15px; object-fit: cover;">
          <p style="margin: 10px 0; font-weight: bold;">烟囱鸭 & Rico</p>
          <p style="margin: 10px 0; font-size: 14px; color: #666;">专注于AE扩展开发，致力于提升设计师工作效率</p>
          <div style="margin-top: 15px; display: flex; justify-content: center; gap: 15px;">
            ...
            <a href="mailto:contact@example.com" style="text-decoration: none; color: #333;">
              <div style="display: flex; flex-direction: column; align-items: center;">
                ...
                <span style="font-size: 12px; margin-top: 5px;">邮箱</span>
              </div>
            </a>
            <a href="https://space.bilibili.com/" target="_blank" style="text-decoration: none; color: #333;">
              <div style="display: flex; flex-direction: column; align-items: center;">
                ...
                <span style="font-size: 12px; margin-top: 5px;">哔哩哔哩</span>
              </div>
            </a>
          </div>
        </div>
        <div class="custom-alert-buttons">
          <button id="about-panel-close" class="custom-alert-btn confirm">关闭</button>
        </div>
      </div>
    </div>
  `;
  ...
  function showAboutPanel(e) {
    ...
    e.preventDefault();
    aboutPanelOverlay.style.display = 'block';
  }
